...
Next week I will add more questions about calculating closed populations from individually marked animals (not batch marked) using maximum likelihood. We will continue to use the turtle data to see how the estimates compare as our data collection becomes more detailed. Maximum likelihood will also provide us with information about the uncertainty in our estimates, which you will notice wasn't estimated with any of these current batch-mark methods.
