...
## 16. Read in the seals data, explore the data, and make a model of the data (use "Abun" as the dendent data). Describe what dependent variables you chose, why, and what model you used and why you think it might be appropriate.
