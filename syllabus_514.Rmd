...
**Office Hours:** Monday 11:00 - 12:00; Tuesday & Thursday 9:00 - 10:30 AM, Wednesday 9:00 - 10:00 AM; or by appointment
...
* Gain experience accessing and analyzing existing population data
...
Homework assignments     |      100    |  B = 80 – 89% |
Final Exam, comprehensive        |   150      |   C = 70 – 79% |
Attendance & class activities       |  100    |     D = 60 – 69% |
Graduate student assignments           |  100   |     F < 59% |
      |      | |
**Total possible points**               | **650** | |

Total points and assignments may change to accommodate teaching and learning objectives. Grades are still based on percentage of total points. Grades from individual assignments will be posted on [blackboard](https://frostburg.blackboard.com), **however, the grade calculated by blackboard will likely be incorrect because of differences in weighting of assignments**. It is your responsibility to calculate your current grade based on the grading scheme described above.

### Laboratory

**Please note that many of our labs will be conducted at local field sites. These labs will be conducted outside so you are expected to use common sense in deciding what to wear and what to bring. You will get dirty and you will get wet during these labs.** Be prepared to spend 3 hours in areas without restrooms, if you have questions about outdoor restroom etiquette please consult leave-
...
3. Generalized Linear (regression) Models for count data
4. Generalized Linear Mixed Modesl for correlated count data
5. Designing studies and collecting count data in the field
6. Deterministic population dynamics
7. Stochastic population dynamics
8. Problem of imperfect detection and hierarchical modeling
9. Marked populations; turtle &/or salamander mark-recapture field experience
10. Demography and life tables
11. Population Viability Analysis
12. Population genetics

### Graduate student assignments

Graduate students will have 1-2 additional assignments worth a total of 100 points. These assignments are to be determined but may involve conducting additional analyses and presenting the results, teaching a topic during a lecture, designing a class homework assignment, or leading a field trip.
